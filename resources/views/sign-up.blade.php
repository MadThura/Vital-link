    ...
    <body class="m-0 text-gray-200 font-[Segoe_UI] min-h-screen flex overflow-hidden bg-cover bg-center"
        ...
        <!-- Left Pane -->
        <div id="leftPane"
            class="w-[65%] h-screen flex items-center backdrop-blur-xl bg-white/10 border-r border-white/20 rounded-r-[60%] shadow-[inset_0_0_30px_rgba(255,255,255,0.1),0_8px_30px_rgba(0,0,0,0.4)] transform transition-all duration-[1200ms] -translate-x-full opacity-0">
            ...
            <div
                ...
                <form action="" method="POST" enctype="multipart/form-data" class="flex flex-col">
                    ...
                    <p class="text-center text-sm mt-4 text-gray-400">Already have an account?
                        <a href="/" class="text-gray-400 hover:text-red-400 transition-colors underline">Log
                            in</a>
                    </p>
                </form>
            </div>
        ...
        <script>
            ...
            window.addEventListener('DOMContentLoaded', () => {
                leftPane.classList.remove('-translate-x-full', 'opacity-0');
                leftPane.classList.add('translate-x-0', 'opacity-100');
            });
        </script>
    </body>
