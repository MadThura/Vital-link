            ...
            @auth
                ...
                <div class="flex items-center gap-5">
                    @if ($donor?->status === 'approved' || $user->role === 'blood_bank_admin')
                        <button id="openNotificationBtn" class="relative p-3 rounded-full transition-all duration-300 ease-out group bg-gray-100/50 hover:bg-gray-200/70 dark:bg-gray-800/50 dark:hover:bg-gray-700/70 shadow hover:shadow-lg dark:shadow-gray-800/30">
                            ...
                            <span id="notificationCount" class="absolute top-0 right-0 inline-flex items-center justify-center w-5 h-5 text-xs font-medium text-white bg-gradient-to-br from-red-400 to-red-500 rounded-full transform translate-x-1 -translate-y-1 animate-pulse hover:animate-none">
                            </span>
