<div class="w-full max-w-xl h-[90vh] overflow-y-auto scrollbar-none p-6 rounded-2xl bg-white/5 backdrop-blur-md shadow-lg hover:bg-white/15 transition-colors">
