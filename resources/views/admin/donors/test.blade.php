...
{{-- <x-admin-layout>
    <div x-data="{ showDonationDetail: false }">
    <!-- Eye Icon Button -->
    <button class="text-cyan-400 hover:text-cyan-300 p-2 rounded-full hover:bg-gray-700 transition"
            title="View"
            @click="showDonationDetail = true">
        <i class="fas fa-eye"></i>
    </button>

    <!-- Modal -->
    <div x-show="showDonationDetail" x-transition
         class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"
         style="display: none;">
        <div @click.away="showDonationDetail = false"
             class="bg-white text-black rounded-lg shadow-xl p-6 w-[90%] max-w-lg">
            <h2 class="text-xl font-semibold mb-4">Donation Details</h2>
            <p class="mb-4">Here you can show detailed information about this donation request.</p>
